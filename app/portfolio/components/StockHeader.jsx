...
export default function StockHeader({ symbol, portfolioItem , portfolioShare}) {
    ...
    <div className="bg-white shadow-sm rounded-xl p-6 border border-gray-200">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-sm text-gray-500">Your Portfolio Position</p>
        </div>
        ...
        <div>
            <p className="text-sm text-gray-500">Portfolio Share</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-6 text-gray-700">
        ...
        <div>
          ...
          <p className="text-lg font-semibold">{liveData?.currency || "USD"}</p>
        </div>
      </div>
